...
import io.github.kuvandikov.scan_card_nfc.iso7816emv.impl.TagImpl;
...
public final class EmvTags {
	...
	public static final ITag DS_REQUESTED_OPERATOR_ID = new TagImpl("9f5c08", TagValueTypeEnum.BINARY, "DS Requested Operator ID", "");
	// 9f5d 01 01
